...
namespace Has.WebMacro
{
    internal class FolderManager
    {
        ...
        private bool FolderExist(DirectoryInfo directoryInfo)
        {
            return directoryInfo.Exists;
        }

        internal bool ShadowFileExists() => FolderExist(_shadowFilesDirectoryInfo);
        internal bool ContentFileExists() => FolderExist(_contentDirectoryInfo);
